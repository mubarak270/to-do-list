  ...
  return (
    <div className="flex-1 flex flex-col h-full overflow-hidden bg-slate-50/50 dark:bg-slate-900/50">
      ...
      <div className="px-5 pt-4 pb-2">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="p-1 rounded-full hover:bg-slate-200 dark:hover:bg-slate-800 text-slate-700 dark:text-slate-200"
            >
          ...
          <button
            ...
            className="text-xs font-bold text-blue-600 dark:text-blue-400 px-3 py-1.5 rounded-xl bg-blue-50 dark:bg-blue-950/70 border border-blue-200 dark:border-blue-800 hover:bg-blue-100"
          >
            Today
          </button>
        </div>
        ...
        {/* Days of week header */}
        <div className="grid grid-cols-7 text-center text-xs font-bold text-slate-700 dark:text-slate-300 mt-4 mb-2">
          {daysOfWeek.map((day) => (
        ...
        {/* Calendar Grid */}
        <div className="grid grid-cols-7 gap-y-1 text-center select-none bg-white dark:bg-slate-800 rounded-2xl p-2 shadow-xs border border-slate-200 dark:border-slate-700">
          {calendarCells.slice(0, 35).map((cell, idx) => {
            ...
            return (
              <button
                ...
                className={`relative h-10 flex flex-col items-center justify-center rounded-full transition-all group ${
                  isSelected
                    ...
                    : cell.isCurrentMonth
                    ? 'text-slate-800 dark:text-slate-100 font-semibold hover:bg-slate-100 dark:hover:bg-slate-700'
              ...
              >
                ...
                {isToday && !isSelected && (
                  <span className="absolute inset-0 rounded-full border-2 border-blue-500 pointer-events-none" />
                )}
              </button>
            );
          })}
